declare module "tone" {
  ...
  class Tone {
     ...
     */
    static Offline(
      callback: Tone.Callback,
      duration: Tone.Encoding.Time
    ): Promise<Tone.Buffer>;
     ...
     */
    static defaultArg<G extends object, F extends object>(
      given: G,
      fallback: F
    ): G & F;
  ...
  namespace Tone {
    export type Ctor<A extends Array<any> = any[], T = object> = (
      ...args: A
    ) => T;
    ...
    interface Frequency extends TimeBase {
       ...
       */
      harmonize(
        intervals: ReadonlyArray<Encoding.Interval>
    ...
    interface FrequencyConstructor
      extends PrimitiveTypeConstructor<Encoding.Frequency, Frequency> {
    ...
    interface MidiConstructor
      extends PrimitiveTypeConstructor<Encoding.MIDI, Midi> {
      ftom(frequency: Encoding.Frequency): Encoding.MIDI;
      mtof(midi: Encoding.MIDI): Encoding.Frequency;
    }
    ...
    interface TicksConstructor
      extends PrimitiveTypeConstructor<Encoding.Ticks, Ticks> {}
    ...
    interface TimeBaseConstructor
      extends PrimitiveTypeConstructor<Encoding.Time, TimeBase> {}
    ...
    interface Time extends TimeBase {
       ...
       */
      quantize(
        val: number | Encoding.Time,
        percent?: Encoding.NormalRange
      ): number;
    ...
    interface TimeConstructor
      extends PrimitiveTypeConstructor<Encoding.Time, Time> {}
    ...
    interface Transport extends Emitter {
       ...
       */
      setLoopPoints(
        startPosition: Encoding.TransportTime,
        endPosition: Encoding.TransportTime
      ): this;
    ...
    class TimelineState extends Timeline {
       ...
       */
      getLastState<T extends EventObject = EventObject>(
        state: State,
        time: Encoding.Time
      ): T;
       ...
       */
      getNextState<T extends EventObject = EventObject>(
        state: State,
        time: Encoding.Time
      ): T;
    ...
    class Param<E = Encoding.Default, T = number> extends AudioNode {
      ...
      private _exponentialInterpolate(
        t0: number,
        v0: number,
        t1: number,
        v1: number,
    ...
    class Compressor extends AudioNode {
      constructor(
        threshold?: Encoding.Decibels | object,
        ratio?: Encoding.Positive
      );
    ...
    class LFO extends AudioNode {
      constructor(
        frequency?: Encoding.Frequency | object,
        min?: number,
        max?: number
      );
    ...
    class EQ3 extends AudioNode {
      constructor(
        lowLevel?: Encoding.Decibels,
        midLevel?: Encoding.Decibels,
        highLevel?: Encoding.Decibels
      );
    ...
    class MultibandSplit extends AudioNode {
      constructor(
        lowFrequency?: Encoding.Frequency | object,
    ...
    class Sampler extends Instrument {
       ...
       */
      add(
        note: Encoding.Note | Encoding.MIDI,
        url: string | Buffer | AudioBuffer,
        callback?: Callback
      ): void;
    ...
    type SequenceArray = ReadonlyArray<
      Encoding.Note | NoteArray | NoteSequence
    >;
    ...
    class Sequence extends Part {
      constructor(
        callback: Callback,
        events: SequenceArray,
        subdivision: Encoding.Time
      );
    ...
    class PWMOscillator extends Source {
      constructor(
        frequency: Encoding.Frequency,
        modulationFrequency?: Encoding.Frequency
      );
    ...
    class OmniOscillator extends Source {
       ...
       */
      modulationType:
        | FMOscillator["modulationType"]
        | AMOscillator["modulationType"];
    ...
    class SignalBase extends Tone {
       ...
       */
      connect(
        node: ProcessingNode | Signal | SignalBase,
        outputNumber?: number,
        inputNumber?: number
      ): this;
    }
    ...
    class WaveShaper extends SignalBase {
      constructor(
        mapping: WaveShaperMappingFn | ReadonlyArray<number> | number,
        bufferLen?: number
      );
